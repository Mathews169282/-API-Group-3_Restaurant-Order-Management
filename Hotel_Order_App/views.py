...
def Home(request):
    ...
    return render(request, "Hotel_Order_App/Home.html", {"stats": stats, "recent_orders": recent})

def Order_list(request):
    return render(request, "Hotel_Order_App/Order_list.html", {"orders": DEMO_ORDERS})

def Order_detail(request, pk):
    order = next((o for o in DEMO_ORDERS if o["id"] == pk), None)
    return render(request, "Hotel_Order_App/Order_detail.html", {"order": order})
...
def Order_create(request):
    if request.method == "POST":
        ...
        form = OrderForm()
    return render(request, "Hotel_Order_App/Order_form.html", {"form": form})

def Order_edit(request, pk):
    return render(request, "Hotel_Order_App/Order_form.html", {"form": type("F", (), {"instance": type("I", (), {"pk": pk})()})()})


def Menu_list(request):
   
    return render(request, "Hotel_Order_App/menu_list.html", {
