...
class MenuItem(TimeStampedModel):
    ...
    description = models.TextField(
        blank=True, 
        help_text="Detailed item description for customers"
    )
    ...
    image = models.ImageField(
        ...
        blank=True,
        null=True,
        help_text="Product image for display"
    )
    ...
    inventory_count = models.PositiveIntegerField(
        default=0,
        help_text="Current inventory level"
    )
    low_stock_threshold = models.PositiveIntegerField(
        default=10,
        help_text="Inventory level that triggers low stock alerts"
    )
    ...
    def get_dietary_info(self):
        """Return list of dietary attributes for this item"""
        dietary_info = []
