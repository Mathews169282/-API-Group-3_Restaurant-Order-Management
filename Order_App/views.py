...
def Home(request):
    ...
    return render(request, "Order_App/Home.html", {"stats": stats, "recent_orders": recent})

def Order_list(request):
    return render(request, "Order_App/Order_list.html", {"orders": DEMO_ORDERS})
...
def Order_edit(request, pk):
    return render(request, "_Order_App/Order_form.html", {"form": type("F", (), {"instance": type("I", (), {"pk": pk})()})()})


def Menu_list(request):
   
    return render(request, "Order_App/menu_list.html", {
